...
int main() {
    /////// Merged collimator 1 and 3 into new collimator 1 (verify points and make sure this envelope treats the not-col5 cut correctly)
    const int numEnvs = 3;
    ...
    //These are for col4z = 9775.
       // double posZ[numEnvs] = { 9775.0, 12800.0, 29047.5 };
    //These are for col4z = 8275.
    double posZ[numEnvs] = { 8275.0, 12800.0, 29047.5 };
    ...
    //These points are for col4z = 9775. 
    ...
    //These points are for col4z = 8275.
    double col4X[col4points] = {-52.5376056, -50.8, -87.6, -126.5, -163.9, -167.871677, -163.9, -126.5, -87.6, -50.8};
    double col4Y[col4points] = {0.0, 13.4, 21.9, 27.2, 36.3, 0.0, -36.3, -27.2, -21.9, -13.4};
    double col4Z = 8275.;// represents front face of collimator 4, 100 mm thickness is important as well.
