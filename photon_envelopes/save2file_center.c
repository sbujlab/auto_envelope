...
int main() {
    ...
    col3EnvX = targrad +  ((col2rad - targrad)/(col2Z - targetZ)) * (col3Z - targetZ);
    OutFile << col3EnvX << "\t" << y << "\t" << col3Z << "\r\n";

    OutFile << col3rad << "\t" << y << "\t" << col3Z << "\r\n";
    OutFile << col3rad << "\t" << y << "\t" << col3Z+col3thickness << "\r\n";
    col4EnvX = targrad +  ((col3rad - targrad)/(col3Z - targetZ)) * (col4Z - targetZ);
    OutFile << col4EnvX << "\t" << y << "\t" << col4Z << "\r\n";

    OutFile << col4rad << "\t" << y << "\t" << col4Z << "\r\n";
    OutFile << col4rad << "\t" << y << "\t" << col4Z+col4thickness << "\r\n";
    col5EnvX = targrad +  ((col4rad - targrad)/(col4Z - targetZ)) * (col5Z - targetZ);
    OutFile << col5EnvX << "\t" << y << "\t" << col5Z << "\r\n";
